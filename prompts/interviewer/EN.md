...
> **Phase 5 from the [HIRED! How to Get a Job in 2026](../../guides/GET_A_JOB_EN.pdf) guide:** Interviews are conversations between people, not skill assessments.

```
My next interviewer at <COMPANY_NAME> is this person:

Name: <INTERVIEWER_NAME>
Role: <INTERVIEWER_ROLE>
LinkedIn profile: <INTERVIEWER_LINKEDIN_URL>
...
- Topics that could generate a genuine conversation
